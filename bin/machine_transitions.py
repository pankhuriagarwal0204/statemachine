...
morcha_transitions = [
    # secure --> detected
    {'trigger': 'intrusion_detected', 'source': morcha_state_map['secure'], 'dest': morcha_state_map['intrusion_detected'],
    ...
    {'trigger': 'intrusion_detected', 'source': morcha_state_map['intrusion_detected'], 'dest': morcha_state_map['intrusion_detected'],
    ...
    {'trigger': 'intrusion_detected', 'source': morcha_state_map['intrusion_verified'], 'dest': morcha_state_map['intrusion_verified'],
     'after': 'increase_attempts'},
    # verified --> sos raised
    ...
    {'trigger': 'intrusion_detected', 'source': morcha_state_map['marked_safe'], 'dest': morcha_state_map['marked_safe'],
